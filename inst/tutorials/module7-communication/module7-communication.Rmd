...
First, create a new dataset called `potential_outliers` that includes car models from the `mpg` data with 1) `hwy` efficiency greater than 40 OR 2) highway efficiency less than 20 and engine displacement larger than 5.
